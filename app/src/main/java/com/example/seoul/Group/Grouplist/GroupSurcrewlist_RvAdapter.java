...
public class GroupSurcrewlist_RvAdapter extends RecyclerView.Adapter<GroupSurcrewlist_RvAdapter.CustomViewHolder> {

    private Context context;
    private List<Integer> items;
    private int i;

    public GroupSurcrewlist_RvAdapter(Context context, List<Integer> items, int i) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_grouplist_srucrewlist, null);
